...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to storyofpets.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to storyofpets, accessible from{" "}
            <a
              href="https://www.storyofpet.com/"
      ...
      <ul>
        <li>By email: sankalp.nagle@gigatorb.com</li>
      </ul>
    </>
  );
};
